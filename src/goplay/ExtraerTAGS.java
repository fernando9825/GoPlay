...
public class ExtraerTAGS extends Thread {
    ...
    public void Etiquetas(String ubicacion, DefaultTableModel tableModel, int pos, String nombre) throws IOException, UnsupportedTagException, InvalidDataException {
        //Tomando ID3v2 frame values
            ...
            if (mp3file.hasId3v1Tag()) {
                try {
                    ...
                    if (id3v1Tag.getTitle() != null) {
                        ...
                        Object[] fila = {pos, id3v1Tag.getArtist(), nombre, id3v1Tag.getAlbum(), id3v1Tag.getYear(), id3v1Tag.getGenreDescription()};
                        LlenarTabla tab = new LlenarTabla();
                        tab.Llenar(tableModel, fila);
                    }
                } catch (Exception e) {
                ...
                try {
                    ...
                    if (id3v2Tag.getTitle() != null) {
                        ...
                        Object[] fila = {pos, id3v2Tag.getArtist(), nombre, id3v2Tag.getAlbum(), id3v2Tag.getYear(), id3v2Tag.getGenreDescription()};
                        LlenarTabla tab = new LlenarTabla();
                        tab.Llenar(tableModel, fila);
                    }
                } catch (Exception e) {
